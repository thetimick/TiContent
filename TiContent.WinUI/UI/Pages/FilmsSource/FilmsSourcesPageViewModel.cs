            ...
            .Where(
                entity =>
                {
                    if (Filters.QualitiesIndex > 0)
                        return entity.Quality == Filters.Qualities[Filters.QualitiesIndex];
                    
                    if (Filters.TrackerIndex > 0)
                        return entity.Tracker == Filters.Trackers[Filters.TrackerIndex];
                    
                    if (Filters.YearsIndex > 0)
                        return entity.Date.Year.ToString() == Filters.Years[Filters.YearsIndex];
