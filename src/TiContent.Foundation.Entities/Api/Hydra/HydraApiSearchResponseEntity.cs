...
public record HydraApiSearchResponseEntity
{
    ...
    /// </summary>
    [JsonPropertyName("edges")] public List<EdgesEntity>? Edges { get; init; }
    ...
    public record EdgesEntity
    {
        ...
        /// </summary>
        [JsonPropertyName("shop")] public string? Shop { get; init; }
        ...
        /// </summary>
        [JsonPropertyName("installCount")] public int? InstallCount { get; init; }

        /// <summary>
        ///     Количество достижений, связанных с элементом.
        /// </summary>
        [JsonPropertyName("achievementCount")] public int? AchievementCount { get; init; }
        ...
        /// </summary>
        [JsonPropertyName("developer")] public string? Developer { get; init; }
        ...
        /// </summary>
        [JsonPropertyName("reviewScore")] public int? ReviewScore { get; init; }
        ...
        /// </summary>
        [JsonPropertyName("libraryImageUrl")] public string? LibraryImageUrl { get; init; }

        /// <summary>
        ///     Позиция логотипа на изображении.
        /// </summary>
        [JsonPropertyName("logoPosition")] public string? LogoPosition { get; init; }
        ...
        /// </summary>
        [JsonPropertyName("logoImageUrl")] public string? LogoImageUrl { get; init; }

        [JsonIgnore] public string Description => $"{Publisher}\n{Genres.Humanize()}";
    }
}
