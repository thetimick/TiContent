...
public record TMDBResponseEntity
{
    ...
    [JsonPropertyName("results")] public List<ItemEntity>? Results { get; set; }
    ...
    public record ItemEntity
    {
        ...
        [JsonPropertyName("genre_ids")] public List<long>? GenreIds { get; set; }
        ...
        [JsonPropertyName("release_date")] [JsonConverter(typeof(CustomDateTimeOffsetConverter))]
        public DateTimeOffset? ReleaseDate { get; set; }

        [JsonPropertyName("first_air_date")] [JsonConverter(typeof(CustomDateTimeOffsetConverter))]
        ...
        [JsonPropertyName("PG")] public long? Pg { get; set; }

        [JsonPropertyName("release_quality")] public string? ReleaseQuality { get; set; }
        ...
        [JsonPropertyName("kp_rating")] public string? KpRating { get; set; }
    }
}